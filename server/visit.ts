...
export const visitDataByCategory: Record<string, LocationItem[]> = {
    "attractionsOldTown": [
      {
        "nameEn": "Moreška",
        "nameHr": "Moreška",
        "descriptionEn": "Moreška is Korčula’s iconic traditional sword dance, performed for over 400 years. This vibrant spectacle features two groups of costumed dancers enacting a dramatic battle over a captured maiden. Accompanied by rhythmic music, the performance showcases the island's rich cultural heritage.",
        "descriptionHr": "Moreška je kultni tradicionalni mačevalački ples Korčule, koji se izvodi više od 400 godina. Ovaj živopisni spektakl prikazuje dvije skupine kostimiranih plesača u dramatičnoj borbi za otetu djevojku. Uz ritmičnu glazbu, izvedba prikazuje bogatu kulturnu baštinu otoka.",
      ...
      },
      {
        ...
        "descriptionEn": "The Marko Polo Center in Korčula offers an engaging exhibition dedicated to the life and legacy of the famed explorer Marco Polo. Visitors can explore interactive displays detailing his journeys, the historical context of his travels, and his impact on connecting Eastern and Western cultures.",
        "descriptionHr": "Marko Polo centar u Korčuli nudi zanimljivu izložbu posvećenu životu i naslijeđu slavnog istraživača Marka Pola. Posjetitelji mogu istražiti interaktivne prikaze njegovih putovanja, povijesni kontekst tih putovanja i njegov utjecaj na povezivanje istočnih i zapadnih kultura.",
      ...
      },
      {
        ...
        "descriptionEn": "The Gothic-Renaissance St. Mark’s Cathedral is Korčula’s most striking landmark. Built by local stonemasons between the 14th and 16th centuries, it features a majestic bell tower (completed by master Marko Andrijić) and a beautiful rose window over the portal. Inside, the cathedral houses artworks by Tintoretto and other Italian masters, as well as a rich treasury of religious art and artifacts.",
      ...
      },
      {
        ...
        "descriptionEn": "All Saints Church, built in the early 15th century, stands in a quaint square near Korčula’s old city walls. It was home to the Brotherhood of All Saints (est. 1301), one of Korčula’s oldest fraternities. The church’s interior is simple but notable for housing an Icon Collection of precious Cretan icons brought by Korčulan sailors in the 17th century, as well as a series of wooden Baroque carvings and a painted ceiling.",
      ...
      },
      {
        ...
        "descriptionEn": "Tucked away in Korčula’s Old Town is the Ismaelli Courtyard, the secluded inner garden of a 15th-century palace once owned by the noble Ismaeli family. Framed by stone walls and historic architecture, this little courtyard garden offers a peaceful atmosphere with greenery and potted plants – a hidden oasis that evokes the everyday life of Korčulan nobility in Renaissance times.",
    ...
    "restaurants": [
      ...
      },
      {
        ...
        "descriptionEn": "Opened in 2023 in a tucked-away Old Town alley, Konoba Biankura has quickly become a favorite for traditional Korčulan cuisine with a contemporary touch. The restaurant comprises a cozy indoor tavern and a wine bar, both offering a menu of classic Dalmatian dishes – like grilled Adriatic fish, pasticada beef stew with homemade pasta, and seasoned veggies – prepared with modern finesse. Biankura’s chefs prioritize local produce and daily catch, and the extensive wine list highlights Korčula’s Grk and Pošip wines. With its blend of nostalgia and innovation, Biankura provides a memorable dining experience steeped in island tradition.",
