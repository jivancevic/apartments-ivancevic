...
export const apartments = pgTable("apartments", {
  ...
  roomSizeM2: integer("room_size_m2").notNull().default(50),
  bedrooms: jsonb("bedrooms").notNull().default([]),
  ...
  hasCityView: boolean("has_city_view").notNull().default(false),
  hasDishwasher: boolean("has_dishwasher").notNull().default(false),
  hasCoffeeMachine: boolean("has_coffee_machine").notNull().default(false),
  hasHairDryer: boolean("has_hair_dryer").notNull().default(true),
  hasMicrowave: boolean("has_microwave").notNull().default(true),
  hasSmoothieMaker: boolean("has_smoothie_maker").notNull().default(false),
  washingMachineType: text("washing_machine_type").notNull().default("washing"),
